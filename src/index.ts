...
export async function getRandomWord(inputOptions?:Partial<GetRandomWordsOptions>) {
    ...
    if (!options.keepFileForFutureUses) fs.unlinkSync(options.destinationFullPath)
    return result
}
